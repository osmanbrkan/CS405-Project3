...
void main()
{
	...
	//1 line of code for diff calculation
	diff = max(dot(normal, lightdir), 0.0);

	//3 line of code for spec calculation
	vec3 view_direction = normalize(-fragPos); // the view direction,
	vec3 reflect_direction = reflect(-lightdir, normal); // reflection of light direction, -lightdir
    spec = pow(max(dot(view_direction, reflect_direction), 0.0), phongExp);  //spec calculation with adding given phongExp
