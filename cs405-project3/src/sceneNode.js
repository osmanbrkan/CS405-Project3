...
class SceneNode {
    ...
    draw(mvp, modelView, normalMatrix, modelMatrix) {
        ...
        // appyling transofrmations on the above variables with getting transformation matrix and then matrix mult
        // transromedMvp ,transformedmodelview, trasnformednormals, transformed model
        ...
        // drawing child nodes loop
        for (var i = 0; i < this.children.length; i++) {
            this.children[i].draw(transformedMvp, transformedModelView, transformedNormals, transformedModel); //recursive
        }
    }
